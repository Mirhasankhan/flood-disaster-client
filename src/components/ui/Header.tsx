    ...
    <div className="">
      <nav className="text-white sticky top-0 flex z-10 justify-between md:px-8 px-2 h-16  md:h-24 w-full items-center bg-black bg-opacity-40">
        ...
        {role ? (
          ...
          <Link to="/login">
            <Button className="text-white hidden md:block font-semibold bg-blue-600">
              Login
            </Button>
          </Link>
        )}
        <div className="md:hidden transition-all">
          ...
          {open && (
            <div
              ...
              className=" bg-gray-600 transition-transform transform duration-1000 text-white p-5 top-0 left-0 right-0 text-left justify-start absolute flex flex-col w-full"
            >
              <Link to="supplies" className="font-semibold">
                All Supplies
              </Link>
              <Link to="/community" className=" font-semibold my-2">
                Community
              </Link>
              <Link
                to="/leaderboard"
                className="hover:bg-gray-500 font-semibold mb-2"
              >
                Leaderboard
              </Link>
              <div className="flex gap-4">
